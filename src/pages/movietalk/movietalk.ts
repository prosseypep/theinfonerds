...
@Component({
  selector: 'page-movietalk',
  templateUrl: 'movietalk.html',
})

export class MovietalkPage {
	url: string = 'http://www.theinfonerds.com/wp-json/wp/v2/posts?_embed&categories=619';
	items: any;
